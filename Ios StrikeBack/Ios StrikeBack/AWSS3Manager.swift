...
class AWSS3Manager {
    ...
    private init () { }
    let bucketName = "strike-back-bucket" //5
    ...
    private func uploadfile(fileUrl: URL, fileName: String, contenType: String, progress: progressBlock?, completion: completionBlock?) {
        ...
        awsTransferUtility.uploadFile(fileUrl, bucket: bucketName, key: fileName, contentType: "image/jpeg", expression: expression, completionHander: completionHandler)
    }
}
